...
public class ConsultaExecutivoDTO {
    ...
    public ConsultaExecutivoDTO() {
    }

    public ConsultaExecutivoDTO(Long id, String nome, String cpf, String endereco, String telefone, String foto,
                                Boolean mandato, Partido partido) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
